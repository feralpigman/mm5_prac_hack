...
org $BD06
	LDX #$00
  .setStageSelectLoop1:
	LDA .game_over_ram1, x
	STA $00, x
	INX
	CPX #$00
	BNE .setStageSelectLoop1
  .setStageSelectLoop2:
	LDA .game_over_ram2, x
	STA $0100, x
	INX
	CPX #$00
...
// check to see if input is select, if so jump to stage select	
org $BF40
	CMP #$20
	// if not select, continue as normal
	BNE returnToWeaponSelect
	// otherwise jump to stage select
	JMP $BD06
